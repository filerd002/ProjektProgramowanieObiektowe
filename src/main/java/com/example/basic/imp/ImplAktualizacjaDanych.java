...
import com.example.basic.inter.InterAktualizacjaDanych;
...
public class ImplAktualizacjaDanych implements InterAktualizacjaDanych {
    ...
    public List<AktualizacjaDanych> getAll() {
        ...
        try {
            trns = session.beginTransaction();
            users = session.createQuery("from aktualizacja_danych").list();
        } catch (RuntimeException e) {
            e.printStackTrace();
        } finally {
            session.flush();
    ...
    public AktualizacjaDanych getById(int id_aktual_data) {
        ...
        try {
            trns = session.beginTransaction();
            String queryString = "from aktualizacja_danych where id_aktual_data= :id_aktual_data";
