...
import com.example.basic.inter.InterOdczytLicznika;
...
public class ImplOdczytLicznika implements InterOdczytLicznika {
    ...
    public List<OdczytLicznika> getAll() {
        ...
        try {
            trns = session.beginTransaction();
            users = session.createQuery("from odczyt_licznika").list();
        } catch (RuntimeException e) {
            e.printStackTrace();
        } finally {
            session.flush();
    ...
    public OdczytLicznika getById(int id_odczyt_licznika) {
        ...
        try {
            trns = session.beginTransaction();
            String queryString = "from odczyt_licznika where id_odczyt_licznika= :id_odczyt_licznika";
